...
def dashboard_view(request):
    ...
    try:
        ...
        context = {
            ...
            'TEMPLATE_PAA_LIST': get_string('list.title', 'paa'),
            'TEMPLATE_PAA_CREATE': get_string('list.create', 'paa'),
            'TEMPLATE_PAA_APPROVALS': get_string('approval.dashboard_title', 'paa'),
