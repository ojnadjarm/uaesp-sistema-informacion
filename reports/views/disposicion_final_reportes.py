...
def disposicion_final_reportes(request):
    ...
    context = {
        ...
        'TEMPLATE_DASHBOARD_TITLE': get_string('templates.report_builder_title', 'reports'),
        'TEMPLATE_DASHBOARD_DESCRIPTION': get_string('templates.report_builder_description', 'reports'),
        'TEMPLATE_FILTER_DATE_RANGE': get_string('templates.filter_date_range', 'reports'),
        'TEMPLATE_FILTER_START_YEAR': get_string('templates.filter_start_year', 'reports'),
        'TEMPLATE_FILTER_START_MONTH': get_string('templates.filter_start_month', 'reports'),
        'TEMPLATE_FILTER_END_YEAR': get_string('templates.filter_end_year', 'reports'),
        'TEMPLATE_FILTER_END_MONTH': get_string('templates.filter_end_month', 'reports'),
        'TEMPLATE_FILTER_PANEL_TITLE': get_string('templates.filter_panel_title', 'reports'),
        'TEMPLATE_BACK_TO_DASHBOARD': get_string('templates.back_to_main_dashboard', 'reports'),
        'TEMPLATE_FILTER_CONCESIONES': get_string('templates.filter_concesiones', 'reports'),
        'TEMPLATE_FILTER_CONCESIONES_PLACEHOLDER': get_string('templates.filter_concesiones_placeholder', 'reports'),
        'TEMPLATE_FILTER_SERVICIOS': get_string('templates.filter_servicios', 'reports'),
        'TEMPLATE_FILTER_SERVICIOS_PLACEHOLDER': get_string('templates.filter_servicios_placeholder', 'reports'),
        'TEMPLATE_FILTER_ZONAS': get_string('templates.filter_zonas', 'reports'),
        'TEMPLATE_FILTER_ZONAS_PLACEHOLDER': get_string('templates.filter_zonas_placeholder', 'reports'),
        'TEMPLATE_FILTER_CATEGORIAS': get_string('templates.filter_categorias', 'reports'),
        'TEMPLATE_FILTER_CATEGORIAS_PLACEHOLDER': get_string('templates.filter_categorias_placeholder', 'reports'),
        'TEMPLATE_FILTER_ORIGENES': get_string('templates.filter_origenes', 'reports'),
        'TEMPLATE_FILTER_ORIGENES_PLACEHOLDER': get_string('templates.filter_origenes_placeholder', 'reports'),
        'TEMPLATE_FILTER_PIDJ': get_string('templates.filter_pidj', 'reports'),
        'TEMPLATE_FILTER_PIDJ_PLACEHOLDER': get_string('templates.filter_pidj_placeholder', 'reports'),
        'TEMPLATE_FILTER_PIDJ_OPTION_PIDJ': get_string('templates.filter_pidj_option_pidj', 'reports'),
        'TEMPLATE_FILTER_PIDJ_OPTION_NOT_APPLICABLE': get_string('templates.filter_pidj_option_not_applicable', 'reports'),
        'TEMPLATE_FILTER_BUTTON_RUN': get_string('templates.filter_button_run', 'reports'),
        'TEMPLATE_FILTER_BUTTON_EXPORT': get_string('templates.filter_button_export', 'reports'),
        'TEMPLATE_FILTER_BUTTON_RESET': get_string('templates.filter_button_reset', 'reports'),
        'TEMPLATE_SUMMARY_TOTAL_RECORDS': get_string('templates.summary_total_records', 'reports'),
        'TEMPLATE_SUMMARY_TOTAL_WEIGHT': get_string('templates.summary_total_weight', 'reports'),
        'TEMPLATE_TABLE_RESULTS_TITLE': get_string('templates.table_results_title', 'reports'),
        'TEMPLATE_PAGINATION_LABEL': get_string('templates.pagination_label', 'reports'),
        'TEMPLATE_PAGINATION_FIRST_TITLE': get_string('templates.pagination_first_title', 'reports'),
        'TEMPLATE_PAGINATION_PREV_TITLE': get_string('templates.pagination_prev_title', 'reports'),
        'TEMPLATE_PAGINATION_NEXT_TITLE': get_string('templates.pagination_next_title', 'reports'),
        'TEMPLATE_PAGINATION_LAST_TITLE': get_string('templates.pagination_last_title', 'reports'),
        'TEMPLATE_NO_RESULTS_MESSAGE': get_string('templates.no_results_message', 'reports'),
        'TEMPLATE_MODAL_EXPORT_TITLE': get_string('templates.modal_export_title', 'reports'),
        'TEMPLATE_MODAL_EXPORT_SPINNER': get_string('templates.modal_export_spinner', 'reports'),
        'TEMPLATE_MODAL_EXPORT_MESSAGE': get_string('templates.modal_export_message', 'reports'),
        'TEMPLATE_MODAL_EXPORT_WARNING': get_string('templates.modal_export_warning', 'reports'),
        'TEMPLATE_MODAL_EXPORT_DYNAMIC': get_string('templates.modal_export_dynamic', 'reports'),
        'TEMPLATE_MODAL_EXPORT_DYNAMIC_FILTERS': get_string('templates.modal_export_dynamic_filters', 'reports'),
        'TEMPLATE_MODAL_EXPORT_DYNAMIC_SUFFIX': get_string('templates.modal_export_dynamic_suffix', 'reports'),
        'TEMPLATE_MODAL_EXPORT_FILTERS_ZERO': get_string('templates.modal_export_filters_zero', 'reports'),
    }
